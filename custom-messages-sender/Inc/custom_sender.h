...
#define PRINT_INDICATIONS(screen)                                                             \
    ...
    const char indications_row_3[] =                                                          \
        "S to search for a message, E to edit the current field when a message is chosen";    \
    const char indications_row_4[] = "M to go to menu, H to select past sent a past message"; \
    const char indications_row_5[] = "D to go to can dump menu";                              \
