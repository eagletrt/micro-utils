 ...
 * Generation date: 2024-07-15 23:06:23 +0200
 ...
 *
 * @details
 *     - ERROR_GROUP_FIRST The first error with a bunch of instances
 *     - ERROR_GROUP_SECOND no description
 *     - ERROR_GROUP_THIRD no description
 */
typedef enum {
    ERROR_GROUP_FIRST,
    ERROR_GROUP_SECOND,
...
/** @brief Aliases for the first error group instances */
typedef enum {
    ERROR_FIRST_INSTANCE_FIRST_A = 0,
    ERROR_FIRST_INSTANCE_FIRST_B = 3
} ErrorFirstInstanceAlias;

/** @brief Aliases for the third error group instances */
typedef enum {
    ERROR_THIRD_INSTANCE_THIRD = 0
} ErrorThirdInstanceAlias;
